...
const DEMO_ISSUES: {
  ...
  { type: "EPIC", title: "Reporting refresh", status: "To Do", priority: "MEDIUM" },
  { type: "STORY", title: "As a lead, I can see cycle time for the last sprint", status: "To Do", priority: "HIGH", assignee: "kavya.iyer@consint.ai", points: 5 },
  { type: "STORY", title: "As a manager, I can export a report as CSV", status: "To Do", priority: "MEDIUM", points: 3 },
  { type: "TASK", title: "Cache the workload query per project", status: "In Progress", priority: "MEDIUM", assignee: "ananya.reddy@consint.ai", dueInDays: 9, points: 5 },
  { type: "BUG", title: "Burndown draws a flat line after the sprint closes", status: "In Review", priority: "HIGH", assignee: "kavya.iyer@consint.ai" },
  { type: "TASK", title: "Add an audit entry for status changes", status: "Done", priority: "LOW", assignee: "aditi.sharma@consint.ai", points: 2 },
  { type: "STORY", title: "As an admin, I can rename a workflow status", status: "Done", priority: "MEDIUM", assignee: "ananya.reddy@consint.ai", points: 3 },
  { type: "BUG", title: "Filter chips survive a page reload but the list does not", status: "To Do", priority: "HIGH", dueInDays: 1 },
  { type: "TASK", title: "Back-fill missing story points on closed sprints", status: "To Do", priority: "LOWEST" },
  { type: "STORY", title: "As a member, I can watch an issue without commenting", status: "To Do", priority: "LOW", points: 2 },
  { type: "BUG", title: "Timeline bar renders one day short in a negative offset", status: "In Progress", priority: "HIGHEST", assignee: "ananya.reddy@consint.ai", dueInDays: -1 },
  { type: "TASK", title: "Split the notification digest job", status: "To Do", priority: "MEDIUM", points: 8 },
  { type: "STORY", title: "As a lead, I can archive a completed project", status: "In Review", priority: "MEDIUM", assignee: "kavya.iyer@consint.ai", points: 5 },
  { type: "BUG", title: "Search ignores an issue key typed in lowercase", status: "To Do", priority: "MEDIUM" },
  { type: "TASK", title: "Tighten the rate limit on the search endpoint", status: "Done", priority: "HIGH", assignee: "aditi.sharma@consint.ai", dueInDays: -20, points: 2 },
  { type: "STORY", title: "As a viewer, I can subscribe to a saved view", status: "To Do", priority: "LOW", points: 3 },
  { type: "BUG", title: "Comment mentions notify a removed member", status: "In Progress", priority: "HIGH", assignee: "aditi.sharma@consint.ai", dueInDays: 4 },
  { type: "TASK", title: "Document the backfill runbook", status: "To Do", priority: "LOWEST" },
];
